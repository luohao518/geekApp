        ...
        if (conn != null) {
            try {
                ...
                for (RealTimeDataPOJO obj : lr) {
                    ...
                    sql.setDouble(15, obj.getBuy1Price());
                    sql.setDouble(16, obj.getBuy2Num());
                    sql.setDouble(17, obj.getBuy2Price());
                    sql.setDouble(18, obj.getBuy3Num());
                    sql.setDouble(19, obj.getBuy3Price());
                    sql.setDouble(20, obj.getBuy4Num());
                    sql.setDouble(21, obj.getBuy4Price());
                    sql.setDouble(22, obj.getBuy5Num());
                    sql.setDouble(23, obj.getBuy5Price());
                    sql.setDouble(24, obj.getSell1Num());
                    sql.setDouble(25, obj.getSell1Price());
                    sql.setDouble(26, obj.getSell2Num());
                    sql.setDouble(27, obj.getSell2Price());
                    sql.setDouble(28, obj.getSell3Num());
                    sql.setDouble(29, obj.getSell3Price());
                    sql.setDouble(30, obj.getSell4Num());
                    sql.setDouble(31, obj.getSell4Price());
                    sql.setDouble(32, obj.getSell5Num());
                    sql.setDouble(33, obj.getSell5Price());
